...
Pane {
    ...
    palette.text: "#CCBC9D"        // MainColor
    palette.highlight: "#E8E5DC"   // AccentColor
    palette.window: "#262C36"      // BackgroundColor
    palette.button: "transparent"
    palette.buttonText: "#CCBC9D"
    ...
    readonly property color umberFloor: "#262C36"
