...
Pane {
    ...
    palette.text: "#CDBC9A"        // MainColor
    palette.highlight: "#EAE5D9"   // AccentColor
    palette.window: "#272D31"      // BackgroundColor
    palette.button: "transparent"
    palette.buttonText: "#CDBC9A"
    ...
    readonly property color umberFloor: "#272D31"
