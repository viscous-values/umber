...
Pane {
    ...
    palette.text: "#D0BC95"        // MainColor
    palette.highlight: "#EDE6D6"   // AccentColor
    palette.window: "#2B2B2B"      // BackgroundColor
    palette.button: "transparent"
    palette.buttonText: "#D0BC95"
    ...
    readonly property color umberFloor: "#2B2B2B"
