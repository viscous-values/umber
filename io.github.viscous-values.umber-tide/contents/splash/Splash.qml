...
Rectangle {
    ...
    Rectangle {
        anchors.fill: parent
        gradient: Gradient {
            GradientStop { position: 0.0; color: "#202629" }
            GradientStop { position: 1.0; color: "#272D31" }
        }
    }
    ...
    Item {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.0;  color: "#00CDBC9A" }
                GradientStop { position: 0.15; color: "#FFCDBC9A" }
                GradientStop { position: 0.85; color: "#FFCDBC9A" }
