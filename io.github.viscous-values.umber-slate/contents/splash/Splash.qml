...
Rectangle {
    ...
    Rectangle {
        anchors.fill: parent
        gradient: Gradient {
            GradientStop { position: 0.0; color: "#232527" }
    ...
    Item {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.0;  color: "#00CFBC98" }
                GradientStop { position: 0.15; color: "#FFCFBC98" }
                GradientStop { position: 0.85; color: "#FFCFBC98" }
