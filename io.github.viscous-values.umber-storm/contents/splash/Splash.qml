...
Rectangle {
    ...
    Rectangle {
        anchors.fill: parent
        gradient: Gradient {
            GradientStop { position: 0.0; color: "#1F2530" }
            GradientStop { position: 1.0; color: "#262C36" }
        }
    }
    ...
    Item {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.0;  color: "#00CCBC9D" }
                GradientStop { position: 0.15; color: "#FFCCBC9D" }
                GradientStop { position: 0.85; color: "#FFCCBC9D" }
